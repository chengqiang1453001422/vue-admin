  ...
  <a-layout id="components-layout-demo-custom-trigger">
    ...
    >
      ...
      <a-menu theme="dark" mode="inline" :defaultSelectedKeys="['1']" :defaultOpenKeys="['sub1']">
        ...
        <a-sub-menu key="sub1">
            <span slot="title"><a-icon type="gold" /><span>组件</span></span>
    ...
    <a-layout>
      ...
      >
        <a-menu-item key="1"><a-icon type="arrows-alt" /></a-menu-item>
        <a-menu-item key="2"><a-icon type="notification" /><a-badge count="110" /></a-menu-item>
        <a-sub-menu>
